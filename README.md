...
[**Muungano**](https://github.com/Kim8584/Muungano/blob/main/paper/main.pdf) (Swahili for *Union/Connection*) is a decentralized, privacy-preserving financial reputation and trust infrastructure built natively on the [Interledger Protocol](https://www.google.com/url?sa=t&source=web&rct=j&opi=89978449&url=https://interledger.org/&ved=2ahUKEwiyhNalkMCVAxW-hv0HHY_pBFgQFnoECAwQAQ&usg=AOvVaw1VTpTdeTc1ZBacmOBhzMiT) (ILP) and [Open Payments](https://openpayments.dev/) architecture. 
