...
\author{
  \begin{tabular}{c}
    Thomas Mbaru \\ \small{Muungano Explorations} \\ \texttt{tmbaru@usiu.ac.ke}
  \end{tabular}
  \and
  \begin{tabular}{c}
    Betelhem Getachew Kebede \\ \small{Muungano Explorations} \\ \texttt{kebede.betelhem16@gmail.com}
  \end{tabular}
  \and
  \begin{tabular}{c}
    Miles Maveke Kioko \\ \small{Muungano Explorations} \\ \texttt{mkioko1@usiu.ac.ke}
  \end{tabular}
  \\[3ex]
  \begin{tabular}{c}
    Snit Kahsay Teshome \\ \small{Muungano Explorations} \\ \texttt{skteshome@usiu.ac.ke}
  \end{tabular}
  \and
  \begin{tabular}{c}
    Joseph Mumo \\ \small{Muungano Explorations} \\ \texttt{jmumo3@usiu.ac.ke}
  \end{tabular}
  \and
  \begin{tabular}{c}
    Stephen Kimani Njoroge \\ \small{Muungano Explorations} \\ \texttt{sknjorogeus2026@usiu.ac.ke}
  \end{tabular}
  \\[3ex]
  \begin{tabular}{c}
    Emmanuel Kaiga \\ \small{Muungano Explorations} \\ \texttt{ekkibienda@usiu.ac.ke}
  \end{tabular}
}
\date{}
